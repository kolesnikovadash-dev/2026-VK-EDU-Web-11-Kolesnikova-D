...
- модели для пользователей, профилей, вопросов, ответов, тегов и оценок;
- поддержка лайков и дизлайков;
- management command для заполнения базы тестовыми данными;
- подключение PostgreSQL;
- запуск через Docker Compose;
- подключена Django Admin;
- подключен Django Debug Toolbar для режима `DEBUG=True`;
- добавлены кастомные страницы ошибок 404 и 500.
